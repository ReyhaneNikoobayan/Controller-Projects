...
if typ==1
    switch key
        case 1, Kp = (1+L/(3*T))/a  ; Gc_Sys=Kp ; H_Sys=1;
        case 2,
            Kp=(0.9+L/(12*T))/a; Ti=L*(30+3*L/T)/(9+20*L/T);
            Gc_Sys=tf(Kp*[Ti,1],[Ti,0]); H_Sys=1;
        case {3,4}
...
elseif typ==2
    switch key
        case 1, Gc_Sys=tf((1+0.35*tau/(1-tau))/a,1); H_Sys=1;
        case 2,
        ...
        case 5
            ...
            dd=[Td/N,1]; nn=Kp*[Td*(N+1)/N, 1]; Gc_Sys=tf(nn,dd); H_Sys=1;
    end
end
end
